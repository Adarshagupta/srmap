      ...
      <Card className="p-6 space-y-4">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <li>Do not misuse or attempt to abuse app features</li>
            <li>Report any bugs or issues to help improve the app</li>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">3. Account Security</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">4. App License</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            For any questions about these terms or the app in general, please contact:
            <br />
            Adarsh Gupta
            <br />
